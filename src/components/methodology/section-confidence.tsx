        ...
        <div className="space-y-4">
          ...
          <FormulaBlock title="Confidence Score Formula" accentColor="border-primary">
            ...
            <FormulaLine className="text-muted-foreground text-xs mt-1">
              = 100 ×{" "}
              <AnimatedNumber value={breakdown.evidenceQuality} decimals={3} /> ×{" "}
              <AnimatedNumber value={breakdown.modelValidity} decimals={3} /> ×{" "}
              <AnimatedNumber value={breakdown.interactionPenalty} decimals={3} /> ×{" "}
              <AnimatedNumber value={breakdown.magnitudePlausibility} decimals={3} /> ×{" "}
              <AnimatedNumber value={breakdown.rareDiseaseValidity} decimals={3} />
            </FormulaLine>
          ...
          <FormulaBlock title="EQ — Evidence Quality" accentColor="border-blue-500">
            ...
            <FormulaLine highlight>
              EQ = <AnimatedNumber value={breakdown.evidenceQuality} decimals={3} />
            </FormulaLine>
          </FormulaBlock>
          ...
          <FormulaBlock title="MV — Model Validity" accentColor="border-violet-500">
            ...
            <FormulaLine highlight>
              MV = <AnimatedNumber value={breakdown.modelValidity} decimals={3} />
            </FormulaLine>
          </FormulaBlock>
          ...
          <FormulaBlock title="IP — Interaction Penalty" accentColor="border-amber-500">
            ...
            <FormulaLine highlight>
              IP = <AnimatedNumber value={breakdown.interactionPenalty} decimals={3} />
            </FormulaLine>
          </FormulaBlock>
          ...
          <FormulaBlock title="MP — Magnitude Plausibility" accentColor="border-teal-500">
            ...
            <FormulaLine highlight>
              MP = <AnimatedNumber value={breakdown.magnitudePlausibility} decimals={3} />
            </FormulaLine>
          </FormulaBlock>
          ...
          <FormulaBlock title="RP — Rare Disease Validity (OR≈RR)" accentColor="border-rose-500">
            ...
            <FormulaLine highlight>
              RP = <AnimatedNumber value={breakdown.rareDiseaseValidity} decimals={3} />
            </FormulaLine>
          </FormulaBlock>
