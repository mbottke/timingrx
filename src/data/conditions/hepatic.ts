...
export const hepaticConditions: ObstetricCondition[] = [
        ...
        riskData: [
          {
            outcome: "stillbirth",
            statistic: { type: "absolute_risk", valuePer1000: 1.3 },
            populationDescription: "ICP with bile acids <40 umol/L — comparable to background rate",
            citation: cite("other", "Ovadia et al. Lancet 2019", 2019),
          },
        ],
        riskModifiers: [],
        ...
        riskData: [
          {
            outcome: "stillbirth",
            statistic: { type: "absolute_risk", valuePer1000: 2.8 },
            populationDescription: "ICP with bile acids 40-99 umol/L — approximately double the rate of mild ICP",
            citation: cite("other", "Ovadia et al. Lancet 2019", 2019),
          },
          {
            outcome: "spontaneous preterm birth",
            statistic: { type: "relative_risk", value: 2.1 },
            populationDescription: "ICP with elevated bile acids vs general obstetric population",
            citation: cite("other", "Ovadia et al. Lancet 2019", 2019),
          },
        ],
        riskModifiers: [],
        ...
        riskData: [
          {
            outcome: "stillbirth",
            statistic: { type: "absolute_risk", valuePer1000: 34.4 },
            populationDescription: "ICP with bile acids >=100 umol/L — approximately 26x higher than mild ICP",
            citation: cite("other", "Ovadia et al. Lancet 2019", 2019),
          },
          {
            outcome: "stillbirth vs bile acids <40",
            statistic: { type: "odds_ratio", value: 30.5, ci95: [8.0, 116.0] },
            populationDescription: "ICP with bile acids >=100 vs <40 umol/L (Ovadia IPD meta-analysis)",
            citation: cite("other", "Ovadia et al. Lancet 2019", 2019),
          },
        ],
        riskModifiers: [],
    ...
    riskData: [
      {
        ...
        populationDescription: "Liver transplant recipients in pregnancy (range 18-27%)",
        citation: cite("SMFM", "#66", 2023),
      },
      {
        outcome: "preterm birth <37 weeks",
        statistic: { type: "incidence", valuePercent: 30 },
        populationDescription: "Liver transplant recipients in pregnancy (range 25-40%)",
        citation: cite("SMFM", "#66", 2023),
      },
    ],
    riskModifiers: [],
    ...
    riskData: [
      {
        ...
        populationDescription: "AIH in pregnancy — midpoint estimate (range 7-11%)",
        citation: cite("other", "Westbrook et al. Gut 2012", 2012),
      },
      {
        outcome: "postpartum disease flare",
        statistic: { type: "incidence", valuePercent: 38 },
        populationDescription: "AIH postpartum — midpoint estimate (range 25-50%)",
        citation: cite("other", "Westbrook et al. Gut 2012", 2012),
      },
    ],
    riskModifiers: [],
  ...
  },
  {
    ...
    riskData: [
      {
        outcome: "variceal bleeding during pregnancy",
        statistic: { type: "incidence", valuePercent: 25 },
        populationDescription: "Pregnant women with known esophageal varices — predominantly 2nd/3rd trimester",
        citation: cite("other", "Tan et al. Aliment Pharmacol Ther 2016", 2016),
      },
      {
        outcome: "maternal mortality with variceal hemorrhage",
        statistic: { type: "mortality_rate", valuePercent: 18 },
        populationDescription: "Cirrhotic women experiencing variceal bleeding during pregnancy (range 10-25%)",
        citation: cite("other", "Tan et al. Aliment Pharmacol Ther 2016", 2016),
      },
      {
        outcome: "fetal growth restriction",
        statistic: { type: "incidence", valuePercent: 25 },
        populationDescription: "Pregnancies complicated by cirrhosis and portal hypertension (range 20-30%)",
        citation: cite("other", "Tan et al. Aliment Pharmacol Ther 2016", 2016),
      },
    ],
    riskModifiers: [],
